...
```{r figura5,echo = FALSE, message=FALSE, warning=FALSE, fig.cap="\\label{fig:figura5}Number of times the broad exposure category was used in the studies published since 2014", out.width = '95%', fig.align = "center"}
