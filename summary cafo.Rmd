...
years %>%
ggplot(aes(x=as.factor(Year), y=Frecuency, group=1))+geom_line()+geom_point(shape=21, color="black", fill="#69b3a2", size=6)+ylim(0,8)+ xlab("Year of data collection")+ylab("Number of published studies")+labs(caption=" Figure 1")
...
bar %>% ggplot(aes(x=reorder(`Broad.category.Body.system`,-Frecuency),y=Frecuency))+geom_bar(stat="identity", fill="steelblue")+ xlab("Broad Outcome Category")+ylab("Number of times the broad category was used")+coord_flip()+labs(caption=" Figure 4")

bar2 %>% ggplot(aes(x=reorder(`Broad.Cat.Expos`,-Frecuency),y=Frecuency))+geom_bar(stat="identity", fill="steelblue")+xlab("Broad exposure Category")+ylab("Number of times the broad category was used")+coord_flip()+labs(caption=" Figure 5")
